  ...
  return (
    <div className='py-5 px-5 md:px-12 lg:px-28'>
      ...
      <div className='text-center my-8'>
        ...
        <p className='mt-10 max-w-[740px] m-auto text-xs sm:text-base'>In kalyuga the holy name of the Lord, the Hare Kṛṣṇa mahā-mantra is the incarnation of Lord Kṛṣṇa.</p>
